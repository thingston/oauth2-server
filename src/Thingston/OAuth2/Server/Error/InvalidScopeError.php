...
class InvalidScopeError extends Error
{
     ...
     * @param string $uri
     */
    public function __construct(string $description, string $code = ErrorInterface::INVALID_SCOPE_CODE, int $status = ErrorInterface::INVALID_SCOPE_STATUS, string $uri = ErrorInterface::DEFAULT_URI)
    {
